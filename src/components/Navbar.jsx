        ...
        async function fetchComments() {
            try {
                ...
                if (json.comments && Array.isArray(json.comments)) {
                    ...
                    console.error("Expected json.comments to be an array but got:", json.comments);
            ...
            {comments.length === 0 ? (
                ...
                comments.map((comment) => (
                    <div key={comment._id} className="flex items-start mb-6">
                        <img
                            src={comment.profile || "http://localhost:3000/uploads/default-profile.png"}
                            className="w-12 h-12 rounded-full"
                            alt="Profile"
                        />
                        <div className="bg-gray-800 ml-3 p-3 rounded-lg max-w-[75%]">
                            <h1 className="font-bold text-blue-400">{comment.username}</h1>
                            <p className="text-gray-300 break-words">{comment.title}eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee</p>
                        </div>
                    </div>
                ))
            )}
